    ...
    bootstrap() {
        this.router.get('/all', (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let data = yield model_event_1.Event.findAll(options);
                if (data.length > 0)
        ...
        this.router.get('/all/:pageIndex', [
            ...
            try {
                ...
                let data = yield model_event_1.Event.findAndCountAll(options);
        ...
        this.router.get('/:eventId', [
            check_1.param('eventId').isInt(),
            util_validation_1.isValidated,
            md_is_cached_1.isCached
        ], (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                let data = yield model_event_1.Event.findById(req.params.eventId);
                if (data != null)
...
//# sourceMappingURL=route.events.js.map